...
Характеристики в различных режимах работы.

Синус, треугольник, пила, обратная пила, ЭКГ:
Частота 1Гц — 111.1КГц

Высокая частота:
Частота 1Гц — 500.0Кгц


Меандр(высокая частота):
Частота 1МГц. 2МГц, 4МГц, 8МГц
...
Коэффициент заполнения устанавливается в диапазоне 1-99% с шагом в 1%  кнопками +\-.

Внешняя синхронизация может иметь 3 значения, которые выбираются кнопками +\- :
...
Trise — период нарастания импульса диапазон 2 — 1000000мкс.
Ton — период высокого уровня диапазон 2 — 1000000мкс.
Tfall — период спада импульса диапазон 2 — 1000000мкс.
Toff — период низкого уровня диапазон 2 — 1000000мкс.
